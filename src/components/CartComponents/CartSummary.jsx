            ...
            {selectedBranch ? (
              <div className="border p-3 rounded bg-gray-50">
                <p className="font-semibold text-[#D2112C]">
                  {getLocalizedText(selectedBranch.storeName, lang)}
                </p>
                <p className="text-sm text-gray-600">
                  {getLocalizedText(selectedBranch.address, lang)}
                </p>
                ...
                {getLocalizedText(selectedBranch.description, lang)?.trim() && (
                  <p className="text-sm text-gray-600 mt-2">
                    {getLocalizedText(selectedBranch.description, lang)}
                  </p>
                )}
                <button
              ...
              branches.map((branch) => (
                ...
                >
                  <p className="font-semibold text-[#D2112C]">
                    {getLocalizedText(branch.storeName, lang)}
                  </p>
                  <p className="text-sm text-gray-600">
                    {getLocalizedText(branch.address, lang)}
                  </p>
